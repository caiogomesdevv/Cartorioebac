...
#include <locale.h>// biblioteca de alocaço~es de texto por região
#include <string.h>// biblioteca respondável por cuidar das strings
...
int consulta()
{
	...
	if(file == NULL)
	{
		printf("Naõ foi possivel abrir o arquivo, não localizado!.\n");
	}
